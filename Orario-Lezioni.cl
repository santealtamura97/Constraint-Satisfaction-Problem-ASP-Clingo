...
oreGiorno(Giorno, Settimana, N):- N = #count{Ora:slotLezione(_, _, Ora, Giorno, Settimana)}, 
                                                            slotLezione(_, _, _, Giorno, Settimana).
...
giornoSecondaLezione(MinGiorno,Inizio,Settimana,Corso):- #min {Giorno:settimanaSecondaLezione(Giorno,_, _, Corso)} = MinGiorno, settimanaSecondaLezione(MinGiorno,Inizio, Settimana, Corso).
secondoGiornoLezione(Giorno,MaxInizio,Settimana,Corso):- #max {Inizio:giornoSecondaLezione(_,Inizio, _, Corso)} = MaxInizio, giornoSecondaLezione(Giorno,MaxInizio, Settimana, Corso).
